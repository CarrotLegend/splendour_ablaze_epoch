...
public abstract class TopworldPathfinderEntity extends PathfinderMob implements GeoEntity {
    private final AnimatableInstanceCache animationCache = GeckoLibUtil.createInstanceCache(this);

    protected TopworldPathfinderEntity(EntityType<? extends TopworldPathfinderEntity> type, Level level) {
        super(type, level);
    }
